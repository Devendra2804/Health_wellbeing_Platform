        ...
        <nav>
          ...
          <div className="p-4">
            ...
            <div className="grid grid-rows-2 gap-4 font-bold font-poppins mt-4">
              ...
              <Link
                to="#"
                onClick={() => setToggle("HP")}
                className={Toggle === "HP" ? "text-gray-900 " : "text-gray-400"}
              >
                <div className="flex p-2">
                  <h1 className="ml-4">Health Plan</h1>
                </div>
              </Link>

              <Link
                to="#"
                onClick={() => setToggle("NO")}
                className={Toggle === "NO" ? "text-gray-900 " : "text-gray-400"}
              >
                <div className="flex p-2">
                  <h1 className="ml-4">Health Alerts & Notification</h1>
                </div>
              </Link>

              <Link
                to="#"
                onClick={() => setToggle("CDM")}
                className={
                  Toggle === "CDM" ? "text-gray-900 " : "text-gray-400"
                }
              >
                <div className="flex p-2">
                  <h1 className="ml-4">ChronicDisease Management</h1>
                </div>
              </Link>

              <Link
                to="#"
                onClick={() => setToggle("FNH")}
                className={
                  Toggle === "FNH" ? "text-gray-900 " : "text-gray-400"
                }
              >
                <div className="flex p-2">
                  <h1 className="ml-4">Fitness & Nutrition Help</h1>
                </div>
              </Link>

              <Link
                to="#"
                onClick={() => setToggle("MHS")}
                className={
                  Toggle === "MHS" ? "text-gray-900 " : "text-gray-400"
                }
              >
                <div className="flex p-2">
                  <h1 className="ml-4">Mental Health Support</h1>
                </div>
              </Link>

              <Link
                to="#"
                onClick={() => setToggle("CS")}
                className={Toggle === "CS" ? "text-gray-900 " : "text-gray-400"}
              >
                <div className="flex p-2">
                  <h1 className="ml-4">Community Support</h1>
                </div>
              </Link>
            </div>
          </div>
